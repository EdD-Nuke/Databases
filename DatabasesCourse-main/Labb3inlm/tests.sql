...
-- TEST #18: Register to a course when the student does not meet the prerequisistes
-- EXPECTED OUTCOME: Fail
INSERT INTO Registrations VALUES ('1111111118', 'MAD003');

-- TEST #19: Register to a course that the student already has passed
-- EXPECTED OUTCOME: Fail
INSERT INTO Registrations VALUES ('1111111113', 'MAD222');
